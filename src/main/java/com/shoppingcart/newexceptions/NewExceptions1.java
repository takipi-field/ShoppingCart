package com.shoppingcart.newexceptions;
...
public class NewExceptions1 {

	private static final Logger log = LoggerFactory.getLogger(NewExceptions1.class);
	...
	public synchronized void createNewRandomException() {
		...
		if (storedDate == 0 || storedDate < now) {
			storedDate = now;
			log.info("Its a brand new day - lets create a brand new exceptions - conditionally");
