...
public class ShoppingCartProperties extends BaseDomain {
	...
	private boolean workflow14Enabled = true;
	...
	public boolean isWorkflow14Enabled() {
		return workflow14Enabled;
	}
	public void setWorkflow14Enabled(boolean workflow14Enabled) {
		this.workflow14Enabled = workflow14Enabled;
	}
	...
	public String getUrlConnectString() {
		return urlConnectString;
	}
	public void setUrlConnectString(String urlConnectString) {
		this.urlConnectString = urlConnectString;
	}
	...
	public void print() {
		...
		log.info("URL Connect String is: {}", urlConnectString);
		...
		log.info("Workflow14 enabled is: {}", workflow14Enabled);	
	}
