...
public class URLConnectionReader6 {

	private static final Logger log = LoggerFactory.getLogger(URLConnectionReader6.class);
	...
	public static void connectAndCreateErrors(String connectString) {
		...
		if (randomNumber == 5) {
			...
			connectAndCreateErrors(connectString, 8);			
		}
	}
