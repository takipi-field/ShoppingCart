...
public class URLConnectionReader7 {

	private static final Logger log = LoggerFactory.getLogger(URLConnectionReader7.class);

	public static void connectAndCreateErrors(String connectString) {
		//Fail 1 in 10 attempts - take 10 seconds to connect and fail.
		int randomNumber = RandomUtil.generateRandom(15);
